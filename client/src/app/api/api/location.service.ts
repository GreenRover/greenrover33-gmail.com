...
export class LocationService {
     ...
     */
    public create(body: Location, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public create(body: Location, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public create(body: Location, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public create(body: Location, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('post',`${this.basePath}/location`,
            {
                body: body,
    ...
    public delete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('delete',`${this.basePath}/location/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public get(id: number, observe?: 'body', reportProgress?: boolean): Observable<Location>;
    public get(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Location>>;
    public get(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Location>>;
    public get(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Location>('get',`${this.basePath}/location/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public list(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<HavingPK>>('get',`${this.basePath}/location`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public paged(page: number, items: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (items === null || items === undefined) {
            throw new Error('Required parameter items was null or undefined when calling paged2.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public update(body: Location, id: number, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public update(body: Location, id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public update(body: Location, id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public update(body: Location, id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('put',`${this.basePath}/location/${encodeURIComponent(String(id))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
